...
namespace SIGVerse.FCSC.Common
{
	...
	public class PlaybackScoreEventController : PlaybackEventControllerBase<PlaybackScoreEventList, PlaybackScoreEvent>
	{
		...
		{
			// Score
			if (headerArray[1] == CompetitionPlaybackCommon.DataType1Score)
			{
		...
		{
			string definitionLine = "0.0," + CompetitionPlaybackCommon.DataType1Score; // Elapsed time is dummy.
		...
		{
			string dataLine = elapsedTime + "," + CompetitionPlaybackCommon.DataType1Score;
