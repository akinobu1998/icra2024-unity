...
namespace SIGVerse.FCSC.Common
{
	...
	{
		private CompetitionPlaybackPlayer playbackPlayer;
		private GameObject destination;

		public PlaybackPanelNoticeEventController(CompetitionPlaybackPlayer playbackPlayer, GameObject destination)
		{
		...
		{
			// Notice of a Panel
			if (headerArray[1] == CompetitionPlaybackCommon.DataType1PanelNotice)
			{
		...
		{
			string dataLine = elapsedTime + "," + CompetitionPlaybackCommon.DataType1PanelNotice;
