...
namespace SIGVerse.FCSC.Common
{
	...
	public class PlaybackTaskInfoEventController : PlaybackEventControllerBase<PlaybackTaskInfoEventList, PlaybackTaskInfoEvent>
	{
		...
		{
			// TaskInfo
			if (headerArray[1] == CompetitionPlaybackCommon.DataType1TaskInfo)
			{
		...
		{
			string definitionLine = "0.0," + CompetitionPlaybackCommon.DataType1TaskInfo; // Elapsed time is dummy.
